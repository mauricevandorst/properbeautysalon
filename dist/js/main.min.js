! function() {
    ...
    if (e.classList.remove("no-js"), e.classList.add("js"), document.body.classList.contains("has-animations")) {
        ...
        e.reveal(".hero-title, .hero-paragraph, .hero-cta", {
            ...
            origin: "left",
            interval: 150
        }), e.reveal(".hero-illustration, .logo, .privacy-policy", {
            duration: 1e3,
            distance: "40px",
            easing: "cubic-bezier(0.5, -0.01, 0, 1.005)",
            origin: "right",
            interval: 150
        }), e.reveal(".discount500", {
            duration: 1800,
            distance: "40px",
            easing: "cubic-bezier(0.5, -0.01, 0, 1.005)",
            origin: "right",
